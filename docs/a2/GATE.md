...
| Documentation baseline A | `29ae340addde172781aa2199f864dbb25ea29ccc`；源保护修订后的三层文档、接口与验收候选版本，由后续bookkeeping固定；替代 `817f1bff3b2ac8d59dbe22f6234b200c4dcf2ad1`（更早候选 `9636b1b7b987986c57399e36b9765799c32e09b9` 已被替代），尚未获Owner closure |
...
本轮在上一候选的UTF-8预算、公开失败状态、恢复中断核对及配置固定基础上，补齐WAL打开前拒绝、源头预检进程隔离及源绑定稳定前置，并同步验收。提交此设计后再用独立bookkeeping固定新的A；该记录不是CLOSED记录C。后续实质修订须再次固定新的A并按新版本审查，不能自动沿用旧候选基线。
